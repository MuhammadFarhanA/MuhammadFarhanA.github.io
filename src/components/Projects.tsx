...
import { ArrowUpRight, ExternalLink, Github, Calendar, Code2, FileText, Eye, PenTool } from 'lucide-react';
...
const Projects: React.FC = () => {
  ...
  return (
    <section 
      ref={sectionRef}
      id="projects" 
      className="py-20 bg-gradient-to-br from-slate-50 via-gray-50/80 to-zinc-50/60 dark:from-background-dark dark:to-surface-dark"
    >
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-neutral-600 dark:text-neutral-400 max-w-2xl mx-auto">
              A showcase of recent work demonstrating modern web development and user experience design.
            </p>
          </div>
          ...
          style={{ transitionDelay: '0.6s' }}>
            ...
            >
              <span className="relative z-10 flex items-center gap-2">
                View All Projects
                <ArrowUpRight size={18} className="group-hover/btn:animate-pulse" />
              </span>
