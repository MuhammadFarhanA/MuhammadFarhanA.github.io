        ...
        <div className="container mx-auto px-4 md:px-8 lg:px-16 py-12 relative z-10">
          <div className="max-w-6xl mx-auto">
            ...
            <div 
              ...
              className={`aspect-[16/9] rounded-2xl overflow-hidden mb-16 layered-shadow transform transition-all duration-700 ${
            ...
            >
              <div className="bg-white/80 dark:bg-surface-dark/80 backdrop-blur-sm rounded-xl p-6 border border-neutral-200/50 dark:border-neutral-700/50 layered-shadow hover:shadow-strong transition-all duration-300">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="font-bold text-neutral-900 dark:text-neutral-100">Duration</h3>
                </div>
                <p className="text-neutral-600 dark:text-neutral-400">{project.caseStudy.duration}</p>
              </div>
              ...
              <div className="bg-white/80 dark:bg-surface-dark/80 backdrop-blur-sm rounded-xl p-6 border border-neutral-200/50 dark:border-neutral-700/50 layered-shadow hover:shadow-strong transition-all duration-300">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="font-bold text-neutral-900 dark:text-neutral-100">Role</h3>
                </div>
                <p className="text-neutral-600 dark:text-neutral-400">{project.caseStudy.role}</p>
              </div>
              ...
              <div className="bg-white/80 dark:bg-surface-dark/80 backdrop-blur-sm rounded-xl p-6 border border-neutral-200/50 dark:border-neutral-700/50 layered-shadow hover:shadow-strong transition-all duration-300">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="font-bold text-neutral-900 dark:text-neutral-100">Platform</h3>
                </div>
              ...
              <div className="bg-white/80 dark:bg-surface-dark/80 backdrop-blur-sm rounded-xl p-6 border border-neutral-200/50 dark:border-neutral-700/50 layered-shadow hover:shadow-strong transition-all duration-300">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="font-bold text-neutral-900 dark:text-neutral-100">Year</h3>
                </div>
              ...
              <div className="lg:col-span-2 space-y-12">
                ...
                >
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <h2 className="text-2xl font-bold text-neutral-900 dark:text-neutral-100">Project Overview</h2>
                  </div>
                ...
                >
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <h2 className="text-2xl font-bold text-neutral-900 dark:text-neutral-100">The Challenge</h2>
                  </div>
                  <p className="text-neutral-600 dark:text-neutral-400 leading-relaxed text-lg">
                ...
                <section 
                  ...
                  className={`bg-white/80 dark:bg-surface-dark/80 backdrop-blur-sm rounded-2xl p-8 border border-neutral-200/50 dark:border-neutral-700/50 layered-shadow hover:shadow-strong transition-all duration-700 transform ${
                    visibleSections.includes(4) ? 'translate-y-0 opacity-100' : 'translate-y-12 opacity-0'
                  }`}
                >
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <h2 className="text-2xl font-bold text-neutral-900 dark:text-neutral-100">The Solution</h2>
                  </div>
                  <p className="text-neutral-600 dark:text-neutral-400 leading-relaxed text-lg">
                ...
                <section 
                  ...
                  className={`bg-white/80 dark:bg-surface-dark/80 backdrop-blur-sm rounded-2xl p-8 border border-neutral-200/50 dark:border-neutral-700/50 layered-shadow hover:shadow-strong transition-all duration-700 transform ${
                    visibleSections.includes(5) ? 'translate-y-0 opacity-100' : 'translate-y-12 opacity-0'
                  }`}
                >
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <h2 className="text-2xl font-bold text-neutral-900 dark:text-neutral-100">Results & Impact</h2>
                  </div>
                ...
                >
                  ...
                  <div className="flex flex-wrap gap-3">
                    {project.caseStudy.technologies.map((tech: string, index: number) => (
                      <span 
                        key={index} 
                        className={`tech-tag px-3 py-2 text-sm font-medium rounded-lg border ${getTagColor(tech)}`}
                      >
                        {tech}
                      </span>
                    ))}
                ...
                >
                  ...
                  <div className="flex flex-wrap gap-3">
                    {project.tags.map((tag: string, index: number) => (
                      <span 
                        key={index} 
                        className={`tech-tag px-3 py-2 text-sm font-medium rounded-lg border ${getTagColor(tag)}`}
                      >
                        {tag}
                      </span>
                    ))}
